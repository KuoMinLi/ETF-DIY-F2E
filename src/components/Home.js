...
const Home = () =>{
  return (
    <>
      <section className="flex  items-center justify-center h-[265px] sm:h-[700px] text-L1" style={
          {background: "linear-gradient(264.94deg, rgba(114, 79, 255, 0.4) -2.73%, rgba(0, 0, 0, 0) 32.68%), linear-gradient(98.19deg, rgba(113, 152, 255, 0.5) -6.94%, rgba(47, 47, 47, 0) 28.99%), #050B2A"}
        }>
        <div className="flex flex-col  justify-center  px-8  h-full  bg-[url('https://images.unsplash.com/photo-1615992174118-9b8e9be025e7?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&q=80')]
      bg-no-repeat bg-bottom bg-cover w-full">
